...
private static final String PAGE_URL = BASE_URL + "/Manufacturer/List";
	...
	private void manufactererInfo_FillUp()
	{
		...
		new AddPopUpElements().getManufacterer().inputText("Тестовый");
		...
		new AddPopUpElements().getManufactererAdress().inputText("ул. Тестовая, д. 1");
	}
	...
	private void drugManufactererInfo_FillUp()
	{
		...
		// Название производителя
		new AddPopUpElements().getManufacterer().inputText("Производитель для препарата");
	...
	public void manufactererEdit()
	{
		...
		simpleWait(1);
		new AddPopUpElements().getManufacterer().inputText("Тестовый производитель");
	...
	{
		return new Link(driver, By.xpath("//input[@title='Добавить производителя']"));
	}
	...
	{
		return new Button(driver, By.xpath("//input[@title='Добавить производителя']"));
	}
	...
	private class AddPopUpElements
	{
		...
		{
			return new Custom(driver, By.xpath("//span[text() = 'Добавить производителя препарата']"));
		}
